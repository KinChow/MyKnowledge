...
- 原始位置：`content/working/b-final/multimedia/image-quality-assessment.md`
- 原文快照：`working-multimedia-image-quality-assessment`（personal-note；用于保留作者原始整理，不等同于外部权威来源）
...
- 已联网读取：`https://en.wikipedia.org/wiki/Image_quality`；来源正文已保存为不可变 Source 快照。

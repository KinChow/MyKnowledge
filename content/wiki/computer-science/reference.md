...
evidence:
- claim: 课程资料列表包含 2017 年中文字幕版课程，以及由 Andrej Karpathy 授课的 2016 年英文版课程。
  claim_id: reference-audit-1
  support: personal
  supporting_quotes:
  - evidence_id: evidence-2743908423de
  ...
  targets:
  - evidence_id: evidence-2743908423de
    source_id: working-computer-science-reference
id: reference
kind: reference
...
sources:
- working-computer-science-reference
status: published
tags:
- ai
- deep-learning

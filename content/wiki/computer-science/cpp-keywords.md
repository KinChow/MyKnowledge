...
evidence:
- claim: This is a list of reserved keywords in C++. Since they are used by the language,
    these keywords are not available for re-definition or overloading.
  claim_id: cpp-keywords-audit-1
  support: direct
  supporting_quotes:
  ...
  targets:
  - evidence_id: evidence-281234d66ee1
    source_id: cppreference-cpp-keywords-v2
id: cpp-keywords
kind: reference
...
sources:
- cppreference-cpp-keywords-v2
- working-computer-science-cpp-key-words
status: published
tags:
- cpp
- keywords

...
evidence:
- claim: 本页记录的本地 OpenCL 查询显示设备名为 QUALCOMM Adreno(TM)。
  claim_id: snapdragon-8gen1-local-measurement
  support: personal
  supporting_quotes:
  - evidence_id: evidence-908501db7bb5
    exact: 'CL_DEVICE_NAME: QUALCOMM Adreno(TM)'
  targets:
  - evidence_id: evidence-908501db7bb5
    source_id: working-computer-science-snapdragon-8gen1
id: snapdragon-8gen1
kind: reference
...
sources:
- working-computer-science-snapdragon-8gen1
status: published
tags:
- snapdragon
- opencl

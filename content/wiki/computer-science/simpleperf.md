...
evidence:
- claim: Simpleperf 是 Android NDK 中提供的命令行 CPU 分析工具。
  claim_id: simpleperf-audit-1
  support: direct
  supporting_quotes:
  ...
  targets:
  - evidence_id: evidence-5962807915ae
    source_id: android-simpleperf-v2
id: simpleperf
kind: reference
...
sources:
- android-simpleperf-v2
- working-computer-science-simpleperf
status: published
tags:
- android
- profiling

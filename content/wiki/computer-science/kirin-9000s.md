...
evidence:
- claim: 本页记录的本地 OpenCL 查询显示设备名为 Maleoon 910。
  claim_id: kirin-9000s-local-measurement
  support: personal
  supporting_quotes:
  - evidence_id: evidence-8b5a2f0d9a06
    exact: 'CL_DEVICE_NAME: Maleoon 910'
  targets:
  - evidence_id: evidence-8b5a2f0d9a06
    source_id: working-computer-science-kirin-9000s
id: kirin-9000s
kind: reference
...
sources:
- working-computer-science-kirin-9000s
status: published
tags:
- kirin
- opencl

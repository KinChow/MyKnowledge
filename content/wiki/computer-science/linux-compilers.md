...
- claim: "GCC mirror sites\nOur releases are available on the\nGNU download server
    ...
    ftp.fu-berlin."
  claim_id: linux-compilers-audit-1
  support: direct
  supporting_quotes:
  ...
  targets:
  - evidence_id: evidence-3ea0e57b6bbc
    source_id: web-computer-science-linux-compilers
id: linux-compilers
kind: reference
...
sources:
- web-computer-science-linux-compilers
- working-computer-science-linux-compilers
status: published
tags:
- compiler
- linux

...
evidence:
- claim: CS205 C/C++ Program Design 课程第 5 章 Memory and Pointer 涵盖指针、指针与数组、C 风格内存分配等主题。
  claim_id: cpp-course-chapters-audit-1
  support: direct
  supporting_quotes:
  ...
  targets:
  - evidence_id: evidence-0d1426a4027e
    source_id: web-computer-science-cpp
id: cpp-course-chapters
kind: reference
publication_scope: public
related: []
schema_version: wiki/v1
sources:
- web-computer-science-cpp
- working-computer-science-feature
status: published
tags:
- cpp
- course

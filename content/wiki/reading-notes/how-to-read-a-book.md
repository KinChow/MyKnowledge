...
evidence:
- claim: 阅读能力分为基础阅读、检视阅读、分析阅读、主题阅读四个递进层次。
...
《如何阅读一本书》（阿德勒、范多伦）提出基础阅读、检视阅读、分析阅读、主题阅读四个递进层次，主张主动阅读——阅读的目标是从被动接收信息转向真正理解。

## 核心概念

- **四个阅读层次**：基础阅读（认字）、检视阅读（快速抓框架）、分析阅读（深入理解）、主题阅读（跨书整合）。
- **主动阅读**：阅读不是被动接收，而是带着问题主动寻求理解。
- **理解 vs 资讯**：吸收资讯只是知道"发生了什么"；理解要搞清楚"为什么发生、与其他事实的关联"。

## 工作机制

1. 阅读前明确目标：提升技能 / 拓展认知 / 解决问题；
2. 检视阅读快速概览全书框架，判断是否值得精读；
3. 值得精读的用分析阅读深入：全书在谈什么、细部说了什么、是否真实、与我何干；
4. 更高层次用主题阅读整合多本书的智慧。

## 示例或代码

- 四问应用于任意一本书：全书在谈什么？细部说了什么？是否真实？与我何干？
- 用检视阅读筛选技术书籍：先看目录、索引、序言，再决定精读还是略读。

## 常见误区

- 把"读过"当"理解"：被动翻完不等于理解，主动提问才算；
- 所有书都用同一层次读：工具书用检视/分析，不必每本都主题阅读。

## 证据映射

- `four-levels` claim 由《如何阅读一本书》原书（PDF source `how-to-read-a-book-book`）逐字支撑；
- 检视阅读、四问、理解 vs 资讯等概念为个人笔记转述，按 personal 处理（记录见笔记全文），不上升为外部证据 claim。

## 待验证项

- [ ] 阅读进度未完成（仅检视阅读层次）：分析阅读、主题阅读的笔记与验证待补；
- [ ] 四问、检视阅读等条目若需升级为外部证据，需从原书对应章节锚定逐字引文。

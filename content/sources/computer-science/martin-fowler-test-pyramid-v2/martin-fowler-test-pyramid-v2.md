...
attachments:
- filename: martin-fowler-test-pyramid-v2.html
  kind: document
...
- evidence_id: evidence-b9f2f184d527
  ...
  selector:
    ...
    prefix: 'The Practical Test Pyramid
...
local:
  file_sha256: sha256:5b3a505139d6f48afaa9b90755e0c074d9985b99d8029bf7359f04f735c0359d
  path_ref: local-sidecar:public/martin-fowler-test-pyramid-v2
media_type: text/html
origin: external
raw_ref:
...
You don't even need to adopt full-blown BDD tools like
    Cucumber (though you can). Some assertion libraries
    (like chai.js allow you to write

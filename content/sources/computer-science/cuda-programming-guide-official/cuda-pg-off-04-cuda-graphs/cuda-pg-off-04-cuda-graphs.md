...
attachments:
- filename: cuda-pg-off-04-cuda-graphs.html
  kind: document
  media_type: text/html
  role: original
  sha256: sha256:620d00a6eac4b5de7546b22e4c4eb7eb2128a1cedfd532733849d5ee4612fdb3
confidentiality: public
domain: computer-science
extractor: trafilatura/2.2.0
id: cuda-pg-off-04-cuda-graphs
media_type: text/html
origin: external
raw_ref:
  path: archive/raw/620d00a6eac4b5de7546b22e4c4eb7eb2128a1cedfd532733849d5ee4612fdb3.html
  sha256: sha256:620d00a6eac4b5de7546b22e4c4eb7eb2128a1cedfd532733849d5ee4612fdb3
read_status: retrieved
retrieval:
  acquisition: fetch
  resolved_url: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/cuda-graphs.html
  url: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/cuda-graphs.html
schema_version: source/v1
snapshot_sha256: sha256:b01b43a3d61baa6ec4059d15645f9a352e78b10f215813a3e8fb771fbfc574c1
source_type: doc
vault_id: public
---
4.2. CUDA Graphs#
...
Memory nodes:
- It is not possible to update a cudaGraphExec_t with acudaGraph_t if thecudaGraph_t is currently instantiated as a differentcudaGraphExec_t .
...
void graphSetup() {
    ...
    kernelArgs[0] = &handle;
    kernelArgs[1] = &value;
    cudaGraphAddNode(&node, graph, nullptr, nullptr, 0, ¶ms);
    ...
    ...
    cudaGraphAddNode(&node, bodyGraph, nullptr, nullptr, 0, ¶ms);
...
void graphSetup() {
    ...
    ...
    cudaGraphAddNode(&node, ifBodyGraph, nullptr, nullptr, 0, ¶ms);
    ...
    cudaGraphAddNode(&node, elseBodyGraph, nullptr, nullptr, 0, ¶ms);
    // Instantiate and launch the graph
    cudaGraphInstantiate(&graphExec, graph, 0);
    cudaGraphLaunch(graphExec, 0);
    cudaDeviceSynchronize();
...
void graphSetup() {
    ...
    ...
    cudaGraphAddNode(&node, bodyGraphs[0], nullptr, nullptr, 0, ¶ms);
    ...

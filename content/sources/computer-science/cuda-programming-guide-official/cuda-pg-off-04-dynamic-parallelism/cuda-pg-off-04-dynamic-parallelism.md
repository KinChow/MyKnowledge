...
attachments:
- filename: cuda-pg-off-04-dynamic-parallelism.html
  kind: document
  media_type: text/html
  role: original
  sha256: sha256:036bd41ea02c771f013c17add1a3475c885d6fb939f2f44003d96c595204e537
confidentiality: public
domain: computer-science
extractor: trafilatura/2.2.0
id: cuda-pg-off-04-dynamic-parallelism
media_type: text/html
origin: external
raw_ref:
  path: archive/raw/036bd41ea02c771f013c17add1a3475c885d6fb939f2f44003d96c595204e537.html
  sha256: sha256:036bd41ea02c771f013c17add1a3475c885d6fb939f2f44003d96c595204e537
read_status: retrieved
retrieval:
  acquisition: fetch
  resolved_url: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/dynamic-parallelism.html
  url: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/dynamic-parallelism.html
schema_version: source/v1
snapshot_sha256: sha256:b40bada5fd9e79a72e289a5ddc91c90d26373d90a228ff4511b82238a2cb975f
source_type: doc
vault_id: public
---
...
4.20.2.1. Parent and Child Grids#
...
4.20.2.2. Scope of CUDA Primitives#
...
4.20.2.4. Ordering and Concurrency#
...
4.20.3. Memory Coherence and Consistency#
...
4.20.4.2. C++ Language Interface for CDP#
...
4.20.4.2.1. Device-Side Kernel Launch#
Kernels may be launched from the device using the standard CUDA <<< >>> syntax:
kernel_name<<< Dg, Db, Ns, S >>>([kernel arguments]);
- Dg is of typedim3 and specifies the dimensions and size of the grid
- Db is of typedim3 and specifies the dimensions and size of each thread block
- Ns is of typesize_t and specifies the number of bytes of shared memory that is dynamically allocated per thread block for this call in addition to statically allocated memory.Ns is an optional argument that defaults to 0.
- S is of typecudaStream_t and specifies the stream associated with this call. The stream must have been allocated in the same grid where the call is being made.S is an optional argument that defaults to the NULL stream.
4.20.4.2.1.1. Launches are Asynchronous#
...
4.20.4.2.1.2. Launch Environment Configuration#
...
4.20.5. Programming Guidelines#
4.20.5.1. Performance#
4.20.5.1.1. Dynamic-parallelism-enabled Kernel Overhead#
...
4.20.5.2. Implementation Restrictions and Limitations#
...
4.20.5.2.1.2. Pending Kernel Launches#
...
4.20.5.3. Compatibility and Interoperability#
...
4.20.6. Device-side Launch from PTX#
...
4.20.6.2. Parameter Buffer Layout#

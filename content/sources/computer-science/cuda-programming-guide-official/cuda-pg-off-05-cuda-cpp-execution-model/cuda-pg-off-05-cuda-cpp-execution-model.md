...
attachments:
- filename: cuda-pg-off-05-cuda-cpp-execution-model.html
  kind: document
  media_type: text/html
  role: original
  sha256: sha256:7d6359f3592c9281be6aff3606d10abbccb13f9d986fa585df0163b6c4599b2f
confidentiality: public
domain: computer-science
extractor: trafilatura/2.2.0
id: cuda-pg-off-05-cuda-cpp-execution-model
media_type: text/html
origin: external
raw_ref:
  path: archive/raw/7d6359f3592c9281be6aff3606d10abbccb13f9d986fa585df0163b6c4599b2f.html
  sha256: sha256:7d6359f3592c9281be6aff3606d10abbccb13f9d986fa585df0163b6c4599b2f
read_status: retrieved
retrieval:
  acquisition: fetch
  resolved_url: https://docs.nvidia.com/cuda/cuda-programming-guide/05-appendices/cuda-cpp-execution-model.html
  url: https://docs.nvidia.com/cuda/cuda-programming-guide/05-appendices/cuda-cpp-execution-model.html
schema_version: source/v1
snapshot_sha256: sha256:6f3ed5f3a3fa6580576c1b34cb74d2e17f907194f567423fa0a2b178d86cea47
source_type: doc
vault_id: public
---
...
- Otherwise, all device threads in its thread-block cluster shall eventually make progress. [Note: Threads in other thread-block clusters are not guaranteed to eventually make progress. - end note.] [Note: This implies that all device threads within its thread block shall eventually make progress. - end note.]
...
Examples of forward progress guarantee differences between host and device threads due to modifications to [intro.progress.1].
...
CUDA query functions (e.g. cudaStreamQuery,
cudaEventQuery, etc.) shall not consistently

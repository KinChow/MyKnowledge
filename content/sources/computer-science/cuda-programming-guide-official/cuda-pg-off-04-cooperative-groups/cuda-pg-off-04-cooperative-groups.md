...
attachments:
- filename: cuda-pg-off-04-cooperative-groups.html
  kind: document
  media_type: text/html
  role: original
  sha256: sha256:253ad0530f4e2cadfaa3c3095a24991cad43ea07b06df1ab0030e3b8bc31aca4
confidentiality: public
domain: computer-science
extractor: trafilatura/2.2.0
id: cuda-pg-off-04-cooperative-groups
media_type: text/html
origin: external
raw_ref:
  path: archive/raw/253ad0530f4e2cadfaa3c3095a24991cad43ea07b06df1ab0030e3b8bc31aca4.html
  sha256: sha256:253ad0530f4e2cadfaa3c3095a24991cad43ea07b06df1ab0030e3b8bc31aca4
read_status: retrieved
retrieval:
  acquisition: fetch
  resolved_url: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/cooperative-groups.html
  url: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/cooperative-groups.html
schema_version: source/v1
snapshot_sha256: sha256:f016c0d26eb5f490b438008890d7b6831181aa16bcf492d4d1b0a0cbaa80bc47
source_type: doc
vault_id: public
---
...
- barrier_arrive returns anarrival_token object that must be passed into the correspondingbarrier_wait , where it is consumed and cannot be used again.
Programmers must take care to avoid hazards when using Cooperative Groups barriers:
- No collective operations can be used by a group after calling barrier_arrive and before callingbarrier_wait .
- barrier_wait only guarantees that all threads in the group have calledbarrier_arrive .barrier_wait does NOT guarantee that all threads have calledbarrier_wait .
namespace cg = cooperative_groups;
...
- invoke_one_broadcast is the same asinvoke_one except the result of the call is also broadcast to all threads in the group.

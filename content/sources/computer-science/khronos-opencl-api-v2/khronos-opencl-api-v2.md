...
attachments:
- filename: khronos-opencl-api-v2.bin
  kind: document
...
local:
  file_sha256: sha256:26ac1b0470f965a447193bb64c3638af5028a815a237becd09cd5b2634b7b64e
  path_ref: local-sidecar:public/khronos-opencl-api-v2
media_type: application/xml
origin: external
raw_ref:
...
retrieval:
  ...
  url: https://raw.githubusercontent.com/KhronosGroup/OpenCL-Docs/main/xml/cl.xml
...
server's OpenCL/api-docs repository.
    ...
    <types comment="OpenCL type definitions">
        ...
        <type category="define">typedef <type>cl_bitfield</type>      <name>cl_device_integer_dot_product_capabilities</name>;</type>
        ...
        <type category="define">typedef <type>cl_properties</type>    <name>cl_command_properties_khr</name>;</type>
        ...
        <type category="define">#define <name>CL_VERSION_PATCH_MASK</name> ((1 &lt;&lt; CL_VERSION_PATCH_BITS) - 1)</type>

        <type category="define">#define <name>CL_VERSION_MAJOR</name>(version) ((version) &gt;&gt; (CL_VERSION_MINOR_BITS + CL_VERSION_PATCH_BITS))</type>
        <type category="define">#define <name>CL_VERSION_MINOR</name>(version) (((version) &gt;&gt; CL_VERSION_PATCH_BITS) &amp; CL_VERSION_MINOR_MASK)</type>
        <type category="define">#define <name>CL_VERSION_PATCH</name>(version) ((version) &amp; CL_VERSION_PATCH_MASK)</type>

        <type category="define">#define <name>CL_MAKE_VERSION</name>(major, minor, patch) \
    ((((major) &amp; CL_VERSION_MAJOR_MASK) &lt;&lt; (CL_VERSION_MINOR_BITS + CL_VERSION_PATCH_BITS)) | \
    (((minor) &amp;  CL_VERSION_MINOR_MASK) &lt;&lt; CL_VERSION_PATCH_BITS) | \
    ((patch) &amp; CL_VERSION_PATCH_MASK))</type>
    ...
    ((patch) &amp; CL_VERSION_PATCH_MASK_KHR))</type>
        ...
        <type category="struct" name="cl_device_integer_dot_product_acceleration_properties">
...
#define CL_ICD2_TAG_KHR ((intptr_t)0x4F50454E434C3331)
    ...
    <enums name="Constants.uuid" vendor="Khronos" comment="UUID constants, in cl.h">
        <enum value="16"            name="CL_UUID_SIZE"/>
        <enum value="8"             name="CL_LUID_SIZE"/>
    </enums>
    ...
    <enums name="cl_device_type" vendor="Khronos" type="bitmask">
        ...
        <enum bitpos="32"           name="CL_DEVICE_TYPE_RESERVED0_QCOM"/>
    ...
    <enums name="cl_mem_flags" vendor="Khronos" type="bitmask">
        ...
        <enum bitpos="6"            name="CL_MEM_IMMUTABLE_EXT"/>
    ...
    <enums name="cl_device_scheduling_controls_capabilities_arm" vendor="Arm" type="bitmask">
        ...
        <enum bitpos="7"            name="CL_DEVICE_SCHEDULING_COMPUTE_UNIT_LIMIT_ARM"/>
    ...
    <enums start="0x1000" end="0x107F" name="cl_device_info" vendor="Khronos">
        ...
        <enum value="0x1005"        name="CL_DEVICE_MAX_WORK_GROUP_SIZES"/>
        ...
        <enum value="0x106A"        name="CL_DEVICE_UUID"/>
        <enum value="0x106B"        name="CL_DRIVER_UUID_KHR"/>
        <enum value="0x106B"        name="CL_DRIVER_UUID"/>
        <enum value="0x106C"        name="CL_DEVICE_LUID_VALID_KHR"/>
        <enum value="0x106C"        name="CL_DEVICE_LUID_VALID"/>
        <enum value="0x106D"        name="CL_DEVICE_LUID_KHR"/>
        <enum value="0x106D"        name="CL_DEVICE_LUID"/>
        <enum value="0x106E"        name="CL_DEVICE_NODE_MASK_KHR"/>
        <enum value="0x106E"        name="CL_DEVICE_NODE_MASK"/>
        ...
        <enum value="0x1073"        name="CL_DEVICE_INTEGER_DOT_PRODUCT_CAPABILITIES"/>
        <enum value="0x1074"        name="CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT_KHR"/>
        <enum value="0x1074"        name="CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT"/>
        <enum value="0x1075"        name="CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_4x8BIT_PACKED_KHR"/>
        <enum value="0x1075"        name="CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_4x8BIT_PACKED"/>
        ...
        <enum value="0x10C3"        name="CL_ABGR"/>
            <unused start="0x10C4" end="0x10CF" comment="Reserved for cl_ext_yuv_images #722"/>
        ...
        <enum value="0x10E1"        name="CL_UNORM_INT10X6_EXT"/>
            <unused start="0x10E2" end="0x10E2" comment="Reserved for cl_ext_yuv_images #722"/>
        ...
        <enum value="0x10E6"        name="CL_UNSIGNED_INT10X6_EXT"/>
        <enum value="0x10E7"        name="CL_UNSIGNED_INT12X4_EXT"/>
        <enum value="0x10E8"        name="CL_UNSIGNED_INT14X2_EXT"/>
        <enum value="0x10E9"        name="CL_UNORM_INT12X4_EXT"/>
        <enum value="0x10EA"        name="CL_UNORM_INT14X2_EXT"/>
        ...
        <enum value="0x12B5"        name="CL_IMAGE_REQUIREMENTS_MAX_DEPTH_EXT"/>
        ...
        <enum value="0x12BA"        name="CL_DEVICE_SPIRV_EXTENSIONS"/>
        <enum value="0x12BB"        name="CL_DEVICE_SPIRV_CAPABILITIES_KHR"/>
        <enum value="0x12BB"        name="CL_DEVICE_SPIRV_CAPABILITIES"/>
    ...
    <enums start="0x4220" end="0x422F" name="enums.4220" vendor="IMG">
        ...
        <enum value="0x422B"        name="CL_COMMAND_QUEUE_SCHEDULING_WORK_GROUP_EXECUTE_COUNT_IMG"/>
            <unused start="0x422C" end="0x422C" comment="Reserved"/>
        <enum value="0x422D"        name="CL_SEMAPHORE_FAST_PATH_IMG"/>
            <unused start="0x422E" end="0x422F"/>
    </enums>
    ...
    <enums start="0x4260" end="0x426F" name="enums.4260" vendor="Codeplay">
            <unused start="0x4260" end="0x426F"/>
    </enums>

    <enums start="0x4270" end="0x427F" name="enums.4270" vendor="Qualcomm">
            <unused start="0x4270" end="0x427F"/>
    </enums>

    <enums start="0x4280" end="0x428F" name="enums.4280" vendor="VeriSilicon">
            <unused start="0x4280" end="0x428F"/>
    </enums>

    <enums start="0x4290" end="0x429F" name="enums.4290" vendor="Google">
            <unused start="0x4290" end="0x429F"/>
    </enums>

    <enums start="0x42A0" end="0x42AF" name="enums.42A0" vendor="Mastiṣka AI">
    ...
    <enums start="0x42C0" end="0x42DF" name="enums.42C0" vendor="Qualcomm">
            <unused start="0x42C0" end="0x42DF"/>
    </enums>

    <enums start="0x42E0" end="0x4FFF" name="enums.42E0" comment="Reserved for vendor extensions. Allocate in groups of 16.">
    ...
    <commands>
        ...
        <command suffix="CL_API_SUFFIX__VERSION_1_2">
            ...
            <param>const <type>cl_semaphore_payload_khr</type>* <name>sema_payload_list</name></param>
            <param><type>cl_uint</type>                    <name>num_events_in_wait_list</name></param>
            <param>const <type>cl_event</type>*            <name>event_wait_list</name></param>
            <param><type>cl_event</type>*                  <name>event</name></param>
        </command>
        ...
        <command>
            ...
            <param><type>cl_command_buffer_khr</type>     <name>command_buffer</name></param>
            <param><type>cl_command_queue</type>          <name>command_queue</name></param>
            <param>const <type>cl_command_properties_khr</type>*           <name>properties</name></param>
        ...
        <command suffix="CL_API_SUFFIX__VERSION_2_0">
            <proto><type>cl_int</type>                                     <name>clCommandSVMMemcpyKHR</name></proto>
            <param><type>cl_command_buffer_khr</type>                      <name>command_buffer</name></param>
            <param><type>cl_command_queue</type>                           <name>command_queue</name></param>
            <param>const <type>cl_command_properties_khr</type>*           <name>properties</name></param>
            <param><type>void</type>*                                      <name>dst_ptr</name></param>
        ...
        <command suffix="CL_API_SUFFIX__VERSION_2_0">
            <proto><type>cl_int</type>                                     <name>clCommandSVMMemFillKHR</name></proto>
            <param><type>cl_command_buffer_khr</type>                      <name>command_buffer</name></param>
            <param><type>cl_command_queue</type>                           <name>command_queue</name></param>
            <param>const <type>cl_command_properties_khr</type>*           <name>properties</name></param>
            <param><type>void</type>*                                      <name>svm_ptr</name></param>
        ...
        <command>
            <proto><type>cl_command_buffer_khr</type>         <name>clRemapCommandBufferKHR</name></proto>
            <param><type>cl_command_buffer_khr</type>         <name>command_buffer</name></param>
            <param><type>cl_bool</type>                       <name>automatic</name></param>
            <param><type>cl_uint</type>                       <name>num_queues</name></param>
            <param>const <type>cl_command_queue</type>*       <name>queues</name></param>
        ...
        <command suffix="CL_API_SUFFIX__VERSION_3_1">
            <proto><type>cl_int</type>                                  <name>clGetKernelSuggestedLocalWorkSize</name></proto>
            <param><type>cl_command_queue</type>                        <name>command_queue</name></param>
            <param><type>cl_kernel</type>                               <name>kernel</name></param>
            <param><type>cl_uint</type>                                 <name>work_dim</name></param>
            <param>const <type>size_t</type>*                           <name>global_work_offset</name></param>
        ...
        <command>
            <proto><type>cl_int</type>                                  <name>clInitLayerWithProperties</name></proto>
            <param><type>cl_uint</type>                                 <name>num_entries</name></param>
            <param>const <type>cl_icd_dispatch</type>*                  <name>target_dispatch</name></param>
            <param><type>cl_uint</type>*                                <name>num_entries_ret</name></param>
            <param>const <type>cl_icd_dispatch</type>**                 <name>layer_dispatch_ret</name></param>
            <param>const <type>cl_layer_properties</type>*              <name>properties</name></param>
        </command>
        <command>
        ...
        <command suffix="CL_API_SUFFIX__VERSION_3_0">
            ...
            <param>const <type>cl_image_format</type>*                  <name>image_format</name></param>
            <param>const <type>cl_image_desc</type>*                    <name>image_desc</name></param>
            <param><type>cl_image_requirements_info_ext</type>          <name>param_name</name></param>
            <param><type>size_t</type>                                  <name>param_value_size</name></param>
            <param><type>void</type>*                                   <name>param_value</name></param>
            <param><type>size_t</type>*                                 <name>param_value_size_ret</name></param>
        </command>
        ...
        <command>
            <proto><type>cl_int</type>                                  <name>clSetPerfHintQCOM</name></proto>
            <param><type>cl_context</type>                             <name>context</name></param>
            <param><type>cl_perf_hint_qcom</type>                            <name>perf_hint</name></param>
        </command>
    </commands>
    ...
    <feature api="opencl" name="CL_VERSION_1_0" number="1.0" comment="OpenCL core API interface definitions">
        ...
        <require comment="OpenCL 1.0 cl_device_info enums that were deprecated in OpenCL 3.1">
    ...
    <feature api="opencl" name="CL_VERSION_3_1" number="3.1" comment="OpenCL core API interface definitions">
        <require>
            <type name="cl_device_integer_dot_product_capabilities"/>
            <type name="cl_device_integer_dot_product_acceleration_properties"/>
        </require>
        <require comment="Size Constants">
            <enum name="CL_UUID_SIZE"/>
            <enum name="CL_LUID_SIZE"/>
        </require>
        <require comment="cl_device_info">
            <enum name="CL_DEVICE_UUID"/>
            <enum name="CL_DRIVER_UUID"/>
            <enum name="CL_DEVICE_LUID_VALID"/>
            <enum name="CL_DEVICE_LUID"/>
            <enum name="CL_DEVICE_NODE_MASK"/>
            <enum name="CL_DEVICE_INTEGER_DOT_PRODUCT_CAPABILITIES"/>
            <enum name="CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_8BIT"/>
            <enum name="CL_DEVICE_INTEGER_DOT_PRODUCT_ACCELERATION_PROPERTIES_4x8BIT_PACKED"/>
            <enum name="CL_DEVICE_SPIRV_EXTENDED_INSTRUCTION_SETS"/>
            <enum name="CL_DEVICE_SPIRV_EXTENSIONS"/>
            <enum name="CL_DEVICE_SPIRV_CAPABILITIES"/>
            <enum name="CL_DEVICE_MAX_WORK_GROUP_SIZES"/>
        </require>
        <require comment="cl_device_integer_dot_product_capabilities">
            <enum name="CL_DEVICE_INTEGER_DOT_PRODUCT_INPUT_4x8BIT"/>
            <enum name="CL_DEVICE_INTEGER_DOT_PRODUCT_INPUT_4x8BIT_PACKED"/>
        </require>
        <require>
            <command name="clGetKernelSuggestedLocalWorkSize"/>
        </require>
    </feature>
    ...
    <extensions>
        ...
        <extension name="cl_loader_layers" revision="1.0.1" supported="opencl">
            <require>
            ...
            <require comment="Misc API enums">
                ...
                <enum name="CL_LAYER_PROPERTIES_LIST_END"/>
            </require>
            <require>
                <command name="clGetLayerInfo"/>
                <command name="clInitLayer"/>
                <command name="clInitLayerWithProperties"/>
        ...
        <extension name="cl_ext_device_fission" revision="1.0.0" supported="opencl">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require>
        ...
        <extension name="cl_ext_migrate_memobject" revision="1.0.0" supported="opencl">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require>
        ...
        <extension name="cl_khr_gl_sharing" revision="1.0.0" supported="opencl" ratified="opencl">
            ...
            <require condition="defined(CL_VERSION_1_2)">
        ...
        <extension name="cl_intel_unified_shared_memory" revision="1.1.0" supported="opencl">
            ...
            <require>
                ...
                <command name="clMemBlockingFreeINTEL"/>
            ...
            <require comment="deprecated, use clEnqueueMemFillINTEL instead">
                <command name="clEnqueueMemsetINTEL"/>
            </require>
        </extension>
        <extension name="cl_khr_device_uuid" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl">
            <require comment="Size Constants">
        ...
        <extension name="cl_arm_scheduling_controls" revision="0.0.0" supported="opencl">
            ...
            <require comment="cl_device_scheduling_controls_capabilities_arm">
                ...
                <enum name="CL_DEVICE_SCHEDULING_COMPUTE_UNIT_LIMIT_ARM"/>
            </require>
            <require comment="cl_device_info">
        ...
        <extension name="cl_khr_extended_versioning" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_0" ratified="opencl">
            ...
            <require>
                <type name="CL_VERSION_MAJOR_MASK_KHR"/>
                <type name="CL_VERSION_MINOR_MASK_KHR"/>
                <type name="CL_VERSION_PATCH_MASK_KHR"/>
            </require>
            <require>
                <type name="CL_VERSION_MAJOR_KHR"/>
                <type name="CL_VERSION_MINOR_KHR"/>
                <type name="CL_VERSION_PATCH_KHR"/>
            </require>
            <require>
        ...
        <extension name="cl_khr_suggested_local_work_size" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require>
        ...
        <extension name="cl_khr_integer_dot_product" revision="2.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require>
        ...
        <extension name="cl_khr_semaphore" revision="1.0.0" supported="opencl" depends="CL_VERSION_1_2" ratified="opencl">
            ...
            <require>
                ...
                <type name="cl_semaphore_properties_khr"/>
                <type name="cl_semaphore_info_khr"/>
            ...
            <require>
                <command name="clCreateSemaphoreWithPropertiesKHR"/>
                <command name="clEnqueueWaitSemaphoresKHR"/>
                <command name="clEnqueueSignalSemaphoresKHR"/>
                <command name="clGetSemaphoreInfoKHR"/>
                <command name="clReleaseSemaphoreKHR"/>
        ...
        <extension name="cl_khr_external_semaphore_dx_fence" revision="0.9.0" supported="opencl" depends="CL_VERSION_1_2+cl_khr_semaphore+cl_khr_external_semaphore" ratified="opencl" experimental="true">
            <require>
                <type name="CL/cl.h"/>
            </require>
        ...
        <extension name="cl_khr_external_semaphore_win32" revision="0.9.1" supported="opencl" depends="CL_VERSION_1_2+cl_khr_semaphore+cl_khr_external_semaphore" ratified="opencl" experimental="true">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require comment="cl_external_semaphore_handle_type_khr">
        ...
        <extension name="cl_khr_external_memory" revision="1.0.1" supported="opencl" depends="CL_VERSION_3_0" ratified="opencl">
            ...
            <require>
                <command name="clEnqueueAcquireExternalMemObjectsKHR"/>
        ...
        <extension name="cl_khr_external_memory_android_hardware_buffer" revision="0.9.2" supported="opencl" depends="CL_VERSION_3_0+cl_khr_external_memory" ratified="opencl" experimental="true">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require comment="cl_external_memory_handle_type_khr">
                <enum name="CL_EXTERNAL_MEMORY_HANDLE_ANDROID_HARDWARE_BUFFER_KHR"/>
            </require>
        </extension>
        ...
        <extension name="cl_khr_command_buffer" revision="0.9.8" supported="opencl" depends="CL_VERSION_1_2" ratified="opencl" experimental="true">
            ...
            <require>
                ...
                <type name="cl_command_properties_khr"/>
            ...
            <require depends="CL_VERSION_2_0" comment="From version 0.9.4 of the extension">
                <command name="clCommandSVMMemcpyKHR"/>
        ...
        <extension name="cl_ext_image_requirements_info" revision="0.5.0" depends="CL_VERSION_3_0" condition="defined(CL_VERSION_3_0)" supported="opencl">
            ...
            <require comment="cl_image_requirements_info_ext">
                ...
                <enum name="CL_IMAGE_REQUIREMENTS_MAX_WIDTH_EXT"/>
                <enum name="CL_IMAGE_REQUIREMENTS_MAX_HEIGHT_EXT"/>
                <enum name="CL_IMAGE_REQUIREMENTS_MAX_DEPTH_EXT"/>
                <enum name="CL_IMAGE_REQUIREMENTS_MAX_ARRAY_SIZE_EXT"/>
            </require>
            <require comment="Enqueued Commands APIs">
        ...
        <extension name="cl_khr_command_buffer_mutable_dispatch" revision="0.9.5" supported="opencl" depends="cl_khr_command_buffer" ratified="opencl" experimental="true" comment="requires cl_khr_command_buffer 0.9.8 or later">
            ...
            <require comment="cl_command_properties_khr">
            ...
            <require comment="cl_mutable_dispatch_asserts_khr - bitfield">
                <enum name="CL_MUTABLE_DISPATCH_ASSERT_NO_ADDITIONAL_WORK_GROUPS_KHR"/>
            </require>
            <require>
            ...
            <require comment="cl_command_buffer_state_khr">
                <enum name="CL_COMMAND_BUFFER_STATE_FINALIZED_KHR"/>
            </require>
        </extension>
        ...
        <extension name="cl_khr_command_buffer_multi_device" revision="0.9.2" supported="opencl" depends="cl_khr_command_buffer" ratified="opencl" experimental="true" comment="requires cl_khr_command_buffer 0.9.7 or later">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require>
        ...
        <extension name="cl_ext_image_raw10_raw12" revision="1.0.0" depends="CL_VERSION_1_2" supported="opencl">
            <require comment="cl_channel_type">
        ...
        <extension name="cl_khr_extended_bit_ops" revision="1.0.0" supported="opencl"  promotedto="CL_VERSION_3_1" ratified="opencl" comment="OpenCL C only"/>
        ...
        <extension name="cl_khr_subgroup_extended_types" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl" comment="OpenCL C only"/>
        ...
        <extension name="cl_khr_subgroup_shuffle" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl" comment="OpenCL C only"/>
        <extension name="cl_khr_subgroup_shuffle_relative" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl" comment="OpenCL C only"/>
        <extension name="cl_khr_subgroup_clustered_reduce" revision="1.0.0" supported="opencl" ratified="opencl" comment="OpenCL C only"/>
        <extension name="cl_khr_subgroup_rotate" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl" comment="OpenCL C only"/>
        ...
        <extension name="cl_ext_immutable_memory_objects" revision="1.0.0" depends="CL_VERSION_1_2" supported="opencl">
            <require comment="cl_mem_flags">
                <enum name="CL_MEM_IMMUTABLE_EXT"/>
            </require>
        </extension>
        <extension name="cl_qcom_perf_hint" revision="1.0.5" supported="opencl">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require>
                <type name="cl_perf_hint_qcom"/>
            </require>
            <require comment="cl_perf_hint_qcom">
                <enum name="CL_PERF_HINT_HIGH_QCOM"/>
                <enum name="CL_PERF_HINT_NORMAL_QCOM"/>
                <enum name="CL_PERF_HINT_LOW_QCOM"/>
            </require>
            <require comment="cl_context_info">
                <enum name="CL_CONTEXT_PERF_HINT_QCOM"/>
            </require>
            <require>
                <command name="clSetPerfHintQCOM"/>
            </require>
        </extension>
        <extension name="cl_ext_image_unsigned_10x6_12x4_14x2" revision="1.0.0" depends="CL_VERSION_1_2" supported="opencl">
            <require comment="cl_channel_type">
                <enum name="CL_UNSIGNED_INT10X6_EXT"/>
                <enum name="CL_UNSIGNED_INT12X4_EXT"/>
                <enum name="CL_UNSIGNED_INT14X2_EXT"/>
                <enum name="CL_UNORM_INT10X6_EXT"/>
                <enum name="CL_UNORM_INT12X4_EXT"/>
                <enum name="CL_UNORM_INT14X2_EXT"/>
            </require>
        </extension>
        <extension name="cl_khr_spirv_queries" revision="1.0.0" supported="opencl" promotedto="CL_VERSION_3_1" ratified="opencl">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require comment="cl_device_info">
        ...
        <extension name="cl_img_unified_svm_external_memory_dma_buf" revision="1.1.0" supported="opencl" depends="cl_khr_unified_svm" experimental="true" comment="requires cl_khr_unified_svm 0.2.0 or later">
            <require>
                <type name="CL/cl.h"/>
            </require>
        ...
        <extension name="cl_img_external_semaphore_fast_path" revision="0.2.0" supported="opencl" depends="cl_khr_external_semaphore_sync_fd" experimental="true">
            <require>
                <type name="CL/cl.h"/>
            </require>
            <require comment="cl_semaphore_properties_khr">
                <enum name="CL_SEMAPHORE_FAST_PATH_IMG"/>
            </require>
        </extension>

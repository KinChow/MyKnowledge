...
attachments:
- filename: web-computer-science-cpp.txt
  kind: document
...
evidence_items:
- evidence_id: evidence-0d1426a4027e
  position:
    end: 2593
    start: 2497
  ...
  selector:
    exact: '1. Pointers
      ...
      1. Allocate memory in C++ style'
    prefix: 'and Pointer](week05/README.md)
...
- evidence_id: evidence-d0091d2e6b0c
  ...
  selector:
    exact: '1. Functions
      ...
      1. `inline` function'
    prefix: 'f Functions](week06/README.md)
...
- evidence_id: evidence-4eaf855d0d80
  ...
  selector:
    exact: '1. Class template
      ...
      1. `std` classes'
    prefix: 'std Library](week13/README.md)
...
retrieval:
  acquisition: fetch
  resolved_url: https://raw.githubusercontent.com/ShiqiYu/CPP/main/README.md
  url: https://raw.githubusercontent.com/ShiqiYu/CPP/main/README.md

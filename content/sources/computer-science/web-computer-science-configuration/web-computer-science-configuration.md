...
attachments:
- filename: web-computer-science-configuration.html
  kind: document
...
retrieval:
  acquisition: fetch
  resolved_url: https://git-scm.com/book/en/v2/Customizing-Git-Git-Configuration
...
Git Configuration
As you read briefly in Getting Started, you can specify Git configuration settings with the git config command.
...
To begin, download P4Merge from Perforce.

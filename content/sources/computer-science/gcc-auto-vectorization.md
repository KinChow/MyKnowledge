...
- evidence_id: evidence-0784aafedc2e
  ...
  selector:
    exact: "    Basic block vectorization, aka SLP, is enabled by the flag \n    -ftree-slp-vectorize,
      ...
      is enabled."
    prefix: 'vectorized 4 loops in function.
...
- evidence_id: evidence-978b9fdc3358
  ...
  selector:
    ...
    prefix: '.dg/vect/. Information on which
...
- evidence_id: evidence-b44e2c328ac6
  ...
  selector:
    ...
    prefix: 'also use -maltivec. On i?86 and
...
retrieval:
  acquisition: fetch
  resolved_url: https://gcc.gnu.org/projects/tree-ssa/vectorization.html

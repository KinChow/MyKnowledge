...
- 图片范围：每个视频 3 张 bounded 关键帧（3s、10s、20s），共 54 张，manifest 和图片 hash 已校验。
...
- [cs336-official-lecture-03](../cs336-official-lecture-03/cs336-official-lecture-03.md)
- [cs336-official-assignment-01](../cs336-official-assignment-01/cs336-official-assignment-01.md)
...
- 本总览不复制视频 transcript；请通过上表进入每个独立 Source 查看全文和关键帧。

...
| BAK-001 | F012 | ADR-0002/0006 | [backup-and-observability](./technical-design/backup-and-observability.md) | AC-F012-001/002/003/004/006/007/008 | tools/backup.py + tests/test_vault_registry.py（owner entries、manifest/record 双层篡改校验、空仓恢复中途失败清理、合法 manifest 不足以派生 verified）；外部 target/跨 Vault 恢复待补 | Implemented（部分） |

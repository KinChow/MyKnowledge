...
| OPS-002 | F011 | ADR-0002/0006 | [private-vault-submodule](./technical-design/private-vault-submodule.md) | AC-F011-001/002/003/004/008/009/011/014/015/016/019 | tests/test_vault_registry.py + tests/test_api.py + tests/test_vault_transfer.py + tests/test_public_projection.py（Registry、available scope、owner-aware local-projection 合并/原子物化与 CLI、同 Vault 冲突 fail-closed 排除、显式跨 Vault copy/move 与 confidentiality/双锁门禁、跨 Vault 同名/冲突、owner-scoped private read/backlinks、public projection 只消费 declared public root、source delete 失败时 staging 回滚与锁释放）；完整 projection/recovery 演练待补 | Implemented（部分） |

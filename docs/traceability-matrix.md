...
| SKILL-001 | F009 | ADR-0006/0007 | [agent-skill](./technical-design/agent-skill.md) | AC-F009-001/002/003/004/005/006/007/008/009/010/011/012 | tests/test_skill_contract.py + tests/test_skill_runtime.py（白名单、危险参数、preview/apply、MCP stdio、public projection query/read）；完整 source/wiki/validate/publish/token 生命周期待补 | Implemented（部分） |

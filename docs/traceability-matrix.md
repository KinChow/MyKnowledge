...
| OPS-002 | F011 | ADR-0002/0006 | [private-vault-submodule](./technical-design/private-vault-submodule.md) | AC-F011-001/002/003/004/008/009/011/014/015/016/019 | tests/test_vault_registry.py + tests/test_api.py（Registry、跨 Vault 同名/冲突、owner-scoped private read/backlinks、public projection 权限一致性）；领域场景待补 | Implemented（部分） |
...
| QST-001 | F008 | ADR-0008 | [question-and-practice](./technical-design/question-and-practice.md) | AC-F008-001/002/003/004/005/006/007/008/009 | tests/test_question.py + tests/test_api.py + tests/test_vault_registry.py（Wiki/Claim identity 与 hash/批量失效、选择题 option allowlist/简答 rubric/provider、评分记录、FSRS 6.3.2、practice API scoring mode、owner-scoped 备份恢复）；public leak gate/完整恢复仍待补 | Implemented（部分） |

...
| SEC-005 | F007/F011 | ADR-0002/0009 | [static-wiki-publishing](./technical-design/static-wiki-publishing.md), [private-vault-submodule](./technical-design/private-vault-submodule.md) | AC-F007-021/022/023/024/025, AC-F011-012/013/014 | tests/test_frontend_projection.py（active HTML、Mermaid callback/click 和 public path leak gate 拒绝）；完整浏览器 SVG DOM 与 private integration 待补 | Implemented（部分） |

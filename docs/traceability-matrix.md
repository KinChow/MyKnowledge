...
| MIG-001 | F010 | ADR-0001/0005 | [content-migration](./technical-design/content-migration.md) | AC-F010-001/002/003 | tools/inventory_legacy.py + tools/migrate_legacy.py + tests/test_inventory.py/test_migration.py（inventory/preview、代表性样本 Source-first apply、draft Wiki、确定性链接修复、CLI 入口）；全量抽取/发布切换待补 | Implemented（部分） |

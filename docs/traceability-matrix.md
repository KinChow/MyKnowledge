...
| OPS-001 | F004 | ADR-0006 | write-operation-and-locking | AC-F004-001/002/003/004/005/006/010/011 | tests/test_write_operation.py（基础 writer）；领域场景待补 | Implemented（部分） |
...
| 规范 ID | Feature | ADR | 实现设计 | 验收 | 测试 | 状态 |
| --- | --- | --- | --- | --- | --- | --- |
| IDX-002 | F005/F006/F009 | ADR-0007 | [index-and-retrieval](./technical-design/index-and-retrieval.md), [local-api-and-offline](./technical-design/local-api-and-offline.md) | AC-F005-001/002/003/004/005/006, AC-F006-001/002/004/005/007, AC-F009-005 | tests/test_indexing.py（projection/FTS5/fallback）；QMD/API 完整场景待补 | Implemented（部分） |
| API-001 | F006/F009 | ADR-0006/0007 | [local-api-and-offline](./technical-design/local-api-and-offline.md), [agent-skill](./technical-design/agent-skill.md) | AC-F006-001/003/005/007/008/009/010, AC-F009-005/006 | tests/test_api.py（query/retrieve/ask/read/backlinks 基础；完整 API/Skill 待补） | Implemented（部分） |
...
| SKILL-001 | F009 | ADR-0006/0007 | [agent-skill](./technical-design/agent-skill.md) | AC-F009-001/002/003/004/005/006/007/008/009/010 | tests/test_skill_contract.py（基础）；运行集成待补 | Implemented（部分） |
...
| MIG-001 | F010 | ADR-0001/0005 | [content-migration](./technical-design/content-migration.md) | AC-F010-001/002/003 | tools/inventory_legacy.py + tests/test_inventory.py（基础）；Source-first 迁移待补 | Implemented（部分） |
...
| QST-001 | F008 | ADR-0008 | [question-and-practice](./technical-design/question-and-practice.md) | AC-F008-001/002/003/004/005 | tests/test_question.py（基础）；API/恢复/leak gate 待补 | Implemented（部分） |

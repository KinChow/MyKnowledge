...
| QST-001 | F008 | ADR-0008 | [question-and-practice](./technical-design/question-and-practice.md) | AC-F008-001/002/003/004/005/006/007/008 | tests/test_question.py + tests/test_api.py + tests/test_vault_registry.py（hash 失效、批量失效、选择题/简答 rubric/provider、评分记录、FSRS 6.3.2 调度、practice API 及 owner-scoped 备份恢复）；public leak gate/完整恢复仍待补 | Implemented（部分） |

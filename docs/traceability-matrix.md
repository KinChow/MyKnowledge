...
| OPS-001 | F004 | ADR-0006 | write-operation-and-locking | AC-F004-001/002/003/004/005/006/010/011 | tests/test_write_operation.py（preview/apply/回滚/fencing/stale lock recovery/durable audit 校验基础）；领域场景待补 | Implemented（部分） |
...
| QST-001 | F008 | ADR-0008 | [question-and-practice](./technical-design/question-and-practice.md) | AC-F008-001/002/003/004/005/006/007/008/009 | tests/test_question.py + tests/test_api.py + tests/test_vault_registry.py（hash/批量失效、选择题/简答 rubric/provider、评分记录、FSRS 6.3.2、practice API scoring mode、owner-scoped 备份恢复）；public leak gate/完整恢复仍待补 | Implemented（部分） |

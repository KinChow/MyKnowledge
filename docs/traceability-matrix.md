...
| QST-001 | F008 | ADR-0008 | [question-and-practice](./technical-design/question-and-practice.md) | AC-F008-001/002/003/004/005/006 | tests/test_question.py + tests/test_api.py（hash 失效、选择题/简答 rubric 与 provider 边界、评分记录、FSRS 6.3.2 调度、practice API 基础）；恢复/leak gate 待补 | Implemented（部分） |

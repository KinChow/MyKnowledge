...
| VAL-001 | F003 | ADR-0005/0010 | wiki-claim-validation | AC-F003-003/007/008/011/012/013/014/015/016 | tests/validation/test_audit.py + tests/validation/test_ruleset.py（schema/覆盖完整性含额外 claim 拒绝/引文二次校验/报告幂等/规则集 stale）；真实 provider 与 cross-vault 集成待补 | Implemented（部分） |
...
| OPS-002 | F011 | ADR-0002/0006 | [private-vault-submodule](./technical-design/private-vault-submodule.md) | AC-F011-001/002/003/004/008/009/011/014/015/016/019 | tests/test_vault_registry.py + tests/test_api.py（Registry、跨 Vault 同名/冲突、owner-scoped private read/backlinks）；领域场景待补 | Implemented（部分） |
| SKILL-001 | F009 | ADR-0006/0007 | [agent-skill](./technical-design/agent-skill.md) | AC-F009-001/002/003/004/005/006/007/008/009/010/011/012 | tests/test_skill_contract.py + tests/test_skill_runtime.py（白名单、危险参数、preview/apply、MCP stdio、public projection query/read、practice scoring mode 委托）；完整 publish/token 生命周期待补 | Implemented（部分） |
...
| BAK-001 | F012 | ADR-0002/0006 | [backup-and-observability](./technical-design/backup-and-observability.md) | AC-F012-001/002/003/004/006/007/008 | tools/backup.py + tests/test_vault_registry.py（owner entries、manifest/record 双层篡改校验、空仓恢复、合法 manifest 不足以派生 verified）；外部 target/跨 Vault 恢复待补 | Implemented（部分） |
...
| QST-001 | F008 | ADR-0008 | [question-and-practice](./technical-design/question-and-practice.md) | AC-F008-001/002/003/004/005/006/007/008/009 | tests/test_question.py + tests/test_api.py + tests/test_vault_registry.py（hash/批量失效、选择题 option allowlist/简答 rubric/provider、评分记录、FSRS 6.3.2、practice API scoring mode、owner-scoped 备份恢复）；public leak gate/完整恢复仍待补 | Implemented（部分） |

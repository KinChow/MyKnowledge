...
| BAK-001 | F012 | ADR-0002/0006 | [backup-and-observability](./technical-design/backup-and-observability.md) | AC-F012-001/002/003/004/006/007/008 | tools/backup.py + tests/test_vault_registry.py（owner-scoped manifest/restore marker、外部 target manifest/offline bundle 导出与逐项校验且不伪造 verified、backup_not_configured 脱敏 next_action、manifest/record 双层篡改校验、空仓恢复中途失败清理、恢复后 verified 派生）；跨 Vault 恢复待补 | Implemented（部分） |

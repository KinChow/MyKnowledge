...
| OPS-002 | F011 | ADR-0002/0006 | [private-vault-submodule](./technical-design/private-vault-submodule.md) | AC-F011-001/002/003/004/008/009/011/014/015/016/019 | tests/test_vault_registry.py + tests/test_api.py（Registry、available scope、跨 Vault 同名/冲突、owner-scoped private read/backlinks、public projection 权限一致性）；领域场景待补 | Implemented（部分） |

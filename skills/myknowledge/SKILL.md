...
- Source/Wiki changes: call the domain preview operation, show operation ID,
  ...
  before Apply. The Agent channel cannot self-confirm: apply requires an
  operation-confirmation/v1 event generated by the human via
  `python -m tools.cli confirm-apply` (hash-bound to the durable record).
